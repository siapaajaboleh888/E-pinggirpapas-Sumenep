        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                    <span class="mr-2"><a href="/">Home</a></span> <span>Produk</span>
                </p>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>Produk garam hasil karya petambak lokal dengan kualitas terbaik, termasuk Garam Fortifikasi Kelor (GFK)</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    ...
                    <div class="text p-4">
                        ...
                        <p class="days">
                            <span>Stok: {{ $item->stok ?? 'Tersedia' }}</span>
                        </p>
                        <a href="{{ route('produk.show', $item->id) }}" class="btn btn-primary">Detail Produk</a>
                    </div>
                </div>
            </div>
            @empty
            <div class="col-md-12 text-center ftco-animate">
                <div class="alert alert-info">
                    <p>Belum ada produk tersedia. Silakan hubungi kami untuk informasi lebih lanjut.</p>
                </div>
            </div>
            @endforelse
        </div>
