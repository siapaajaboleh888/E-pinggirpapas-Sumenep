        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    {{-- ✅ GANTI GAMBAR HERO → petambak-garam.jpg --}}
                    <img src="{{ asset('assets/images/petambak-garam.jpg') }}" alt="Petambak Garam Pinggirpapas" class="img-fluid rounded-4 shadow-lg">
                </div>
            </div>
        </div>
    </section>

    {{-- ✅ PRODUK UNGGULAN - GAMBAR DISESUAIKAN --}}
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    <div class="product-card">
                        <img src="{{ Storage::url($produk->image) }}" alt="{{ $produk->name }}" class="product-image">
                ...
                @empty
                {{-- ✅ PLACEHOLDER PRODUK dengan GAMBAR LOKAL --}}
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                    <div class="virtual-tour-card">
                        <img src="{{ Storage::url($tour->thumbnail ?? 'petambak-garam.jpg') }}" alt="{{ $tour->title }}">
